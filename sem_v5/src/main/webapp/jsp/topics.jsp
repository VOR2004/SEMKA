...
<html>
<head>
    <link rel="stylesheet" href="<c:url value='/topics.css'/>"/>
...
<script src="<c:url value='/scriptDialog.js'/>"></script>

<div class="conttable">
    <table style="width: 100%;">
        <c:forEach items="${listTopic}" var="comment">
            <tr class="cont" onclick="window.location.href='<c:url value='/topic?id=${comment.id}'/>'" style="cursor: pointer;">
